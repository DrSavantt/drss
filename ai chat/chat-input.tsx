...
interface ChatInputProps {
  onSend: (content: string, mentions: { type: "client" | "framework"; name: string; id: string }[]) => void
  disabled?: boolean
}

export function ChatInput({ onSend, disabled }: ChatInputProps) {
  const [value, setValue] = useState("")
  const [mentions, setMentions] = useState<{ type: "client" | "framework"; name: string; id: string }[]>([])
