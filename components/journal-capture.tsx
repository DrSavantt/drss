      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
        <div className="flex items-center gap-2 mb-3">
          <button
            ...
            className="text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 px-3 py-1.5 rounded-md flex items-center gap-1.5 transition-colors"
          >
            <span>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mt-3 gap-2">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="p-2 hover:bg-gray-100 rounded-md transition-colors flex items-center gap-1 text-xs text-gray-600"
